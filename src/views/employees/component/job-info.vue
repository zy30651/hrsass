    ...
    <el-form :model="formData" label-width="220px">
      <div class="block">
        ...
        <el-form-item  label="岗位">
          <el-input v-model="formData.post" style="width:300px" placeholder="请输入" class="inputW" />
        </el-form-item>
        ...
        <el-form-item label="职级">
          <el-input  v-model="formData.rank"  style="width:300px" class="inputW" />
        </el-form-item>
        <el-form-item label="转正评价">
          <el-input  v-model="formData.correctionEvaluation"  style="width:300px" type="textarea" placeholder="1-300位字符" />
        </el-form-item>
        ...
        <el-form-item class="formInfo" label="调整司龄(天)：">
          <el-input  v-model="formData.adjustmentAgedays"  style="width:300px" type="number" placeholder="请输入" class="inputW" />
        </el-form-item>
      ...
      <div class="block">
        ...
        <el-form-item label="推荐企业/人">
          <el-input  v-model="formData.recommenderBusinessPeople"  style="width:300px" placeholder="请输入" class="infoPosition inputW" />
        </el-form-item>
      </div>
      <!-- 从业信息 -->
      <el-form-item>
...
import { getEmployeesSimple, updateJob, getJobDetail } from '@/api/employees'
export default {
  data() {
    return {
