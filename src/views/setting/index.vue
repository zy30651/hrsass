        ...
        <el-tabs>
          <el-tab-pane label="角色管理">
            ...
            <el-table border="" :data="list">
              <el-table-column align="center" width="120" label="序号" type="index"></el-table-column>
              <el-table-column align="center" width="240" label="角色名" prop="name"></el-table-column>
          ...
          <el-tab-pane label="公司信息">
            ...
            <el-form label-width="120px" style="margin-top:50px">
              ...
              <el-form-item label="备注">
                <el-input v-model="formData.remarks"  type="textarea" :row="3" disabled style="width:400px"></el-input>
              </el-form-item>
            </el-form>
          </el-tab-pane>
        </el-tabs>
...
<script>
import {getRoleList, addRole, getRoleDetail, getCompanyInfo, updateRole, deleteRole} from '@/api/setting'
